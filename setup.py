...
setup(
    ...
    author_email="",
    description="Conversion library to translate YAML into JSON and vice versa",
    license="Mozilla Public License 2.0 (MPL 2.0)",
    keywords="yaml json",
    url="https://github.com/ecaldwe1/json-yaml-converter",
